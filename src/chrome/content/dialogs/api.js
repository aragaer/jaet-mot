...
const AcctTreeView = {
    ...
    getImageSrc:    function (row,col) {
        ...
        case accts[row].deleted:
            return 'chrome://wrapper/content/images/dead.png';
        case !accts[row].isSaved():
            return 'chrome://wrapper/content/images/store.png';
        default:
            return null;
        };
    },
...
function check_data() {
    ...
    tmp.checkLimited(function (ret) {
        if (ret) {
            ...
            document.getElementById('ltd_ok').src = 'chrome://wrapper/content/images/ok.png';
            tmp.checkFull(function (ret) {
                document.getElementById('full_ok').src = ret
                    ? 'chrome://wrapper/content/images/ok.png'
                    : 'chrome://wrapper/content/images/bad.png';
            });
        } else {
            document.getElementById('ltd_ok').src = 'chrome://wrapper/content/images/bad.png';
            document.getElementById('full_ok').src = '';
        }
    });
}
